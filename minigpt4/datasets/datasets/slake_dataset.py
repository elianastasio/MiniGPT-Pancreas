...
class ReferSlakeDataset(Dataset):
    def __init__(self, vis_processor, text_processor, vis_root, ann_path, dataset='refcoco', splitBy='unc'):
        ...
        self.refer = REFER_Slake(ann_path, vis_root)
...
class SlakeDataset(VQADataset, __DisplMixin):
...
class REFER_Slake:
    ...
    def createIndex(self):
        ...
        for item in self.data:
            ...
            self.Imgs[img_id] = {'id': img_id, 'modality': item['modality'], 'height': item['height'], 'width': item['width']}
