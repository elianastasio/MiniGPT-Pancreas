...
class ROCOv2CaptionTrainDataset(BaseDataset, __DisplMixin):
    def __init__(self, vis_processor, text_processor, vis_root, ann_paths):
        """
        vis_root (string): Root directory of images (e.g. coco/images/)
        ann_root (string): directory to store the annotation file
...
class ROCOv2CaptionEvalDataset(BaseDataset, __DisplMixin):
    def __init__(self, vis_processor, text_processor, vis_root, ann_paths):
        """
        vis_root (string): Root directory of images (e.g. coco/images/)
        ann_root (string): directory to store the annotation file
...
class OpeniCaptionDataset(BaseDataset, __DisplMixin):
    def __init__(self, vis_processor, text_processor, vis_root, ann_paths):
        """
        vis_root (string): Root directory of images (e.g. coco/images/)
        ann_root (string): directory to store the annotation file
        ...
        self.instruction_pool = [
            'Please analyze the following X-ray image and provide a diagnosis.',
            'Present a description of this radiology image.',
            'You are an ai medical assistant. Please describe the following radiology image:',
            'Describe the content of the following x-ray image and provide a diagnosis.',
        ]
    def __getitem__(self, index):
