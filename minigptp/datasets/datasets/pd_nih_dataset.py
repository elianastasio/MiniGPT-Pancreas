...
from minigptp.datasets.datasets.vqa_datasets import VQAEvalDataset

class ReferNIHPancreasDataset(Dataset):
    def __init__(self, vis_processor, text_processor, vis_root, ann_path, dataset='refcoco', splitBy='unc'):
        ...
        self.refer = REFER_NIH(ann_path, vis_root)
